...
It depends on the number of records, fields, and capabilities. A typical scan of 10,000 records with 3 capabilities takes a few minutes. See [Limits](/dqs-documentation/reference/limits/) for detailed estimates.
...
The error is logged in the [Error Management Console](/dqs-documentation/processing/error-management/) via platform events. Partial results from completed dimensions are preserved.

## Results

### How long are results retained?

By default, scan results are retained for **30 days** and error logs for **7 days**. These can be adjusted via [retention settings](/dqs-documentation/processing/data-retention/).

### Can I export results?

Yes. Insight Studio supports [CSV export](/dqs-documentation/insight-studio/exports/) of violation details for any dimension.
