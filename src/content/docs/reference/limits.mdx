...
![Definition card showing scan limit reached with red progress bar and scan count](../../../assets/screenshots/scan-limit.png)
...
![Error dialog in Insight Studio indicating that the scan limit has been reached](../../../assets/screenshots/scan-limit-reached.png)

### Requesting More Scans

Click the **Upgrade** button in the error dialog to open a pre-filled email requesting additional scans. The email is addressed to [hello@tucario.com](mailto:hello@tucario.com) and includes your Org ID automatically.

![Pre-filled email requesting scan limit upgrade with Org ID](../../../assets/screenshots/cta-limit-reached.png)

<Aside type="tip">
Scheduled scans also count toward your limit. If you are running low on scans, consider pausing schedules for less critical definitions.
</Aside>
...
With [data retention](/processing/data-retention/) configured, old results are automatically purged.
