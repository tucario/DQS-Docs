...
{/* TODO: Screenshot — Field health matrix grid showing ~10 fields as rows and 4-5 dimensions as columns, with cells color-coded (green, yellow, red, gray). Include at least one field with mixed scores to show the visual contrast. */}
