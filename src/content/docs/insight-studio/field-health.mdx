...
![Scan result drilldown — field results with scores per dimension, color-coded green for high and red for low](../../../assets/screenshots/insight-studio-result-drilldown.png)
