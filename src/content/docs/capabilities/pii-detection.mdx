...
![PII Detection configuration with Detection Patterns presets (Standard, Critical, Extended), pattern list, and Field Overrides](../../../assets/screenshots/pii-generic-view.png)
...
![Per-field configuration modal for the Description field with detection patterns and custom pattern input](../../../assets/screenshots/pii-field-override.png)
