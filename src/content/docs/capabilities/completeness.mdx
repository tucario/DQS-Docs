...
![Completeness configuration with Defaults (Blank Handling, Placeholder Detection), Field Overrides table, and Guidance panel](../../../assets/screenshots/completness-scope-view.png)
...
![Defaults section highlighted with Blank Handling and Placeholder Detection, and Field Overrides table below](../../../assets/screenshots/field-default-settings-override.png)
