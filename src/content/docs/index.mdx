...
- [Install the package](/dqs-documentation/getting-started/installation/)
- [Configure permissions](/dqs-documentation/getting-started/permissions/)
- [Create your first scan](/dqs-documentation/getting-started/quick-start/)
