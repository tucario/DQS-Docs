...
{/* TODO: Screenshot — Definition summary screen showing the "Activate" button with the definition status badge showing "Draft". Include the capability summary cards visible below. */}
...
- **Draft → Active**: Click "Activate" on the summary screen
