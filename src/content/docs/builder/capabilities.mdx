...
|------------|-----------------|
| [Completeness](/dqs-documentation/capabilities/completeness/) | Are fields populated? |
| [Validity](/dqs-documentation/capabilities/validity/) | Do values match expected formats? |
| [Uniqueness](/dqs-documentation/capabilities/uniqueness/) | Are there duplicate values? |
| [Timeliness](/dqs-documentation/capabilities/timeliness/) | Is data up to date? |
| [Consistency](/dqs-documentation/capabilities/consistency/) | Are related fields logically consistent? |
| [PII Detection](/dqs-documentation/capabilities/pii-detection/) | Is personal data properly handled? |
| [AI Readiness](/dqs-documentation/capabilities/ai-readiness/) | Is data suitable for AI/ML use? |
