...
![Capability selection showing 7 quality dimensions — Completeness, Validity, Uniqueness, Timeliness, Consistency, PII Safety, and Data & AI Readiness](../../../assets/screenshots/def-builder-step1-capabilities.png)
