...
{/* TODO: Screenshot — Capability selection view showing the 7 capability cards/tiles. Some should be enabled (highlighted) and some disabled to show the contrast. Completeness and Validity enabled is a good combo. */}
...
{/* TODO: Screenshot — Per-field override modal showing global settings at top and field-specific overrides below. Ideally show a Completeness config with a custom fill rate for one field. */}
