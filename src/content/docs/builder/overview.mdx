...
- **Sidebar** (orange) — Navigation tree showing your definitions and their configuration stages (Capabilities, Scope, Fields, Configure, Review)
- **Stage** (green) — Main content area where you configure each step of the definition
- **Guidance Panel** (red) — Contextual help and guidance that adapts to your current step

![Builder workspace layout with color-coded zones](../../../assets/screenshots/builder-workspace.png)
