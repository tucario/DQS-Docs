...
6. **Run the scan**
   ...
   Go to **Insight Studio** and trigger a scan manually, or set up a [schedule](/dqs-documentation/processing/scheduling/).
...
- Learn about all [7 quality capabilities](/dqs-documentation/capabilities/overview/)
- Explore [Insight Studio dashboards](/dqs-documentation/insight-studio/overview/)
- Set up [automated scan schedules](/dqs-documentation/processing/scheduling/)
