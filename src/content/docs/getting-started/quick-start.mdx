...
{/* TODO: Screenshot — the DQS Home tab showing the Getting Started view with permission cards and "New Definition" CTA. This is the first screen users see. */}
...
{/* TODO: Screenshot — Insight Studio showing scan results for the definition just created. Show the dimension score cards with at least Completeness score visible. */}
