...
Pakiet instaluje:
- Obiekty niestandardowe do definicji, wyników i harmonogramów
- Custom Metadata Types do konfiguracji zdolności, metryk i ustawień
- Komponenty Lightning Web Components dla Builder i Insight Studio
- Klasy Apex do przetwarzania wsadowego i kontrolerów API
- Zestawy uprawnień do kontroli dostępu opartej na rolach

## Aktualizacja pakietu

Aby zaktualizować do nowszej wersji, użyj tego samego linku instalacyjnego — Salesforce wykryje istniejący pakiet i zaproponuje ścieżkę aktualizacji. Definicje skanów i wyniki są zachowywane podczas aktualizacji.
