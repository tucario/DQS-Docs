...
- **Seitenleiste** — Navigationsbaum mit Ihren Definitionen und deren Konfigurationsstufen
- **Stage** — Hauptinhaltsbereich, in dem Sie jeden Schritt der Definition konfigurieren
- **Mentor-Panel** — Kontexthilfe und Anleitung, die sich an Ihren aktuellen Schritt anpasst
