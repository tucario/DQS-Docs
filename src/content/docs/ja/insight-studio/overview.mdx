...
- **サイドバー**（オレンジ）— オブジェクト/定義のナビゲーション、フィルター、内訳オプション
- **ステージ**（緑）— スコア、チャート、データテーブルを含むメインコンテンツエリア
- **ポートフォリオ概要**（赤）— サマリーメトリクス、クイックリンク、コンテキストアクション

![色分けされたゾーンを持つInsight Studioワークスペースのレイアウト](../../../../assets/screenshots/insight-studio-workspace.png)
