...
La página Home también incluye un panel de **Configuration** donde los administradores pueden editar los parámetros predeterminados como Scan Result Retention Days, Purge Batch Size, Purge CRON Expression y Error Log Retention Days directamente desde la interfaz.
