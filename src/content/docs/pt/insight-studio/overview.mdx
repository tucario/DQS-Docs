...
- **Barra lateral** — Navegacao por objeto/definicao, filtros e opcoes de detalhamento
- **Palco** — Area de conteudo principal com pontuacoes, graficos e tabelas de dados
- **Painel Mentor** — Recomendacoes baseadas em IA e acoes contextuais
